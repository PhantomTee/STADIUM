...
/// @notice X Layer patch: replaces tload with sload to match the sstore-based
/// transient state libraries (Lock, NonzeroDeltaCount, CurrencyDelta, CurrencyReserves).
